...
const Home = ()=>{
    ...
    <Link className="self-end w-36 bg-green-700 hover:bg-green-800 active:ring text-neutral-100 shadow p-2 rounded-sm  mt-3" to="/shopping-cart/shop">Go to shop page</Link>
    </div>    
</div>
} 
export default Home